  ...
  */
  ...
  Installer = (function() {
    ...
    function Installer(_arg) {
      this.app = _arg.app, this.url = _arg.url, this.dirname = _arg.dirname, this.db = _arg.db;
    ...
    Installer.prototype.setup_routes = function() {
      ...
      try {
        urls = require(path.join(this.dirname, "routes"));
    ...
    Installer.prototype.setup_middlewares = function() {
      var app, middleware, middlewares, _i, _len, _results;
      try {
        middlewares = require(path.join(this.dirname, "middlewares"));
